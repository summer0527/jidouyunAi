<template>
    <div class="homeStyle" style="width: 1300px;height: 100%;float: left;position: relative;display: flex; align-items: center;margin-right: 2%;">
      ...
      <div class="message-left">
       ...
       <div>
        <div style=" " class="imgstyle">
          <div style="" class="imgto">
            <img
            class="logo mr10"
            src="/image/logono.png"
            alt=""
            style="height: 28px; width: 28px"
          />学科AI场景全覆盖
          </div>
          <div style="" class="imgtwx">
    ...
    height: 150px;"
        ...
        <div  class="imgstyle" style="margin-right: 0;">
          <div class="imgto">
            <img
            class="logo mr10"
            src="/image/logono.png"
