        ...
        <div style="width: 85%">
          <el-form :inline="true" class="demo-form-inline" label-position="top" style="width: 100%;">
            <el-form-item label="辩论赛主题" class="is-required" style="width: 100%;margin-right:0px">
              ...
              <el-input type="textarea" v-model="sqlType" style="width: 100%;" :maxlength="200"></el-input>
            </el-form-item>
          </el-form>
        </div>
      </div>
...
const handleRestNameCom = (item: any) => {
  ...
  request
    .put(resetManApi + item.conversation_id + "/name/", {
      names: item.names,
...
const handleRate = (dataS: any) => {
  ...
  request
    .post(feedbacksManApi + dataS.message_id + "/feedbacks", {
...
const stopFunction = (id: any) => {
  request
    .post(
      stopManApi + id + "/stop?user=" + localStorage.getItem("s_name"),
      {
        user: localStorage.getItem("s_name"),
