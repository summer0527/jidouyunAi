  ...
  <div style="float: left; width: 100%; height: 100%">
    ...
    >
      ...
      <div
        ...
        "
      >
        <div style="position: fixed; bottom: 70px; width: 60%">
          <el-form :inline="true" class="demo-form-inline" :model="translateForm"  :rules="rules"
          ref="ruleFormRef">
            <el-form-item label="学科" class="is-required"  prop="a1">
             <!-- <el-input v-model="translateForm.a1"></el-input> -->
             <el-select
                v-model="translateForm.a1"
                placeholder="请选择"
                clearable
                style="width: 200px"
              >
              <el-option label="数学" value="数学" />
                ...
                <el-option label="生物学" value="生物学" />
                <el-option label="天文学" value="天文学" />
                <el-option label="地质学" value="地质学" />
            ...
            <el-form-item label="难度层次" class="is-required"  prop="a2">
              <el-select
                v-model="translateForm.a2"
                placeholder="请选择"
                clearable
                style="width: 200px"
              >
            ...
            <el-form-item label="题目类型" class="is-required" prop="a3">
             <el-select
                v-model="translateForm.a3"
                placeholder="请选择"
                clearable
                style="width: 200px"
              >
...
const handleRestNameCom = (item: any) => {
  ...
  request
    .put(resetSubjectApi + item.conversation_id + "/name/", {
      names: item.names,
...
const handleRate = (dataS: any) => {
  ...
  request
    .post(feedbacksSubjectApi + dataS.message_id + "/feedbacks", {
...
const stopFunction = (id: any) => {
  request
    .post(
      stopSubjectApi + id + "/stop?user=" + localStorage.getItem("s_name"),
      {
        user: localStorage.getItem("s_name"),
...
const rules = ref<FormRules<TranslateForm>>({
  a1: [
  { required: true, message: "请选择难度层次", trigger: "change" }
  ],
  a2: [{ required: true, message: "请输入题目类型", trigger: "change" }],
  a3: [{ required: true, message: "请输入学科", trigger: "change" }],
...
const fetchStreamData = () => {
  ...
  const rundata = {
    ...
    inputs: {
      a4: senderValue.value,
      a3: translateForm.value.a3,
      a2: translateForm.value.a2,
      a1: translateForm.value.a1,
    },
    conversation_id:
      list.value.length > 0
  ...
  restSender()
  let flag = true
  fetchEventSource(runSubjectApi, {
    method: "POST",
    headers: {
